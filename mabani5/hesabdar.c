...
void MALOOOOC(int **a, int tedad_satr, int tedad_sotun)
{

    a = (int **)malloc(tedad_satr * sizeof(int *));
    for (int i = 0; i < tedad_sotun; i++)
    {
        *(a + i) = (int *)malloc(tedad_sotun * sizeof(int));
    }
}
...
int **tile(int tedad_satr, int tedad_sotun, int tile_sotun, int tile_satr, int **a)
{
    int **NEW_MATRIX;
...
int main()
{
    ...
    for (int i = 1; i < 1000; i++)
    {
        ...
        {
            MALOOOOC(**SAVE, 1, tedad_satr + tedad_sotun);
            **SAVE = ravel(tedad_satr, tedad_sotun, matris);
        ...
        if (strcmp(input, "reshape") == 0)
        {
            ...
            MALOOOOC(**SAVE, new_tedad_satr, new_tedad_sotun);
            **SAVE = reshape(tedad_satr, tedad_sotun, matris, new_tedad_satr, new_tedad_sotun);
        ...
        if (strcmp(input, "resize") == 0)
        {
            ...
            scanf("%d %d", &new_tedad_satr, &new_tedad_sotun);
            MALOOOOC(**SAVE, new_tedad_satr, new_tedad_sotun);
            **SAVE = resize(tedad_satr, tedad_sotun, matris, new_tedad_satr, new_tedad_sotun);
            tedad_satr = new_tedad_satr;
            tedad_sotun = new_tedad_sotun;
        }
        if (strcmp(input, "append_row") == 0)
        {
            ...
            MALOOOOC(**SAVE, tedad_satr + 1, tedad_sotun);
            **SAVE = append_row(tedad_satr, tedad_sotun, matris, b);
            tedad_satr += 1;
        }
        if (strcmp(input, "insert_row") == 0)
        {
            ...
            MALOOOOC(**SAVE, tedad_satr + 1, tedad_sotun);
            **SAVE = insert_row(tedad_satr, tedad_sotun, new_satr, matris, b);
            tedad_satr += 1;
        }
        if (strcmp(input, "append_column") == 0)
        {
            ...
            MALOOOOC(**SAVE, tedad_satr, tedad_sotun + 1);
            **SAVE = append_column(tedad_satr, tedad_sotun, matris, b);
            tedad_sotun += 1;
        }
        if (strcmp(input, "insert_column") == 0)
        {
            ...
            MALOOOOC(**SAVE, tedad_satr, tedad_sotun + 1);
            **SAVE = insert_column(tedad_satr, tedad_sotun, new_sotun, matris, b);
            tedad_sotun += 1;
        }
        if (strcmp(input, "delete_row") == 0)
        {
            ...
            scanf("%d", &delete);
            MALOOOOC(**SAVE, tedad_satr - 1, tedad_sotun);
            **SAVE = delete_row(tedad_satr, tedad_sotun, delete, matris);
            tedad_satr -= 1;
        }
        if (strcmp(input, "delete_column") == 0)
        {
            int delete;
            scanf("%d", &delete);
            *(SAVE + i) = delete_column(tedad_satr, tedad_sotun, delete, matris);
            tedad_sotun -= 1;
        }
        if (strcmp(input, "tile") == 0)
        {
            ...
            *(SAVE + i) = tile(tedad_satr, tedad_sotun, tile_sotun, tile_satr, matris);
            tedad_satr *= tile_satr;
            tedad_sotun *= tile_sotun;
        }
        if (strcmp(input, "transpose") == 0)
        {
            *(SAVE + i) = transpose(tedad_satr, tedad_sotun, matris);
            int temp = tedad_satr;
