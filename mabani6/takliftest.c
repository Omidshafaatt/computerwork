...
void delete(int first_index, int number, char scw, char *input)
{
    ...
    if (scw == 'w')
    {
        ...
        for (int i = first_index; i < strlen(input); i++)
        {
            if (input[i] == ' ' && input[i - 1] != ' ' && i != first_index) ///////////////
            {
                X++;
            }
            if (X == number) ///////////////////  +1 ?
            {
                memmove(&input[first_index], &input[i], strlen(input) - first_index); ///// i - 2? ////// firts index + i - 2
                break;
            }
        }
        if (X < number)
    ...
    *(save + i) = '\0';
    ...
    while (1)
    {
        ...
        case 'E':
            ...
            break;
        case 'd':
            if (dastoorat[strlen(dastoorat) - 1] != 's' && dastoorat[strlen(dastoorat) - 1] != 'c' && dastoorat[strlen(dastoorat) - 1] != 'w' || (dastoorat[1] < '0' || dastoorat[1] > '9' || dastoorat[strlen(dastoorat) - 2] < '0' || dastoorat[strlen(dastoorat) - 2] > '9'))
            {
                printf("invalid command\n");
            }
            else
        ...
        case 'c':
            ...
            break;
        case 'f':
            if (dastoorat[strlen(dastoorat) - 1] != 's' && dastoorat[strlen(dastoorat) - 1] != 'w')
            {
                printf("invalid command\n");
            }
            else
